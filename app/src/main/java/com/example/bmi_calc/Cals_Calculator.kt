...
class Cals_Calculator : AppCompatActivity(), AdapterView.OnItemSelectedListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_cals_calculator)
        ...
        val adapter = ArrayAdapter.createFromResource(this,
                R.array.spinner_Gender_array, android.R.layout.simple_spinner_item)
    ...
    private fun calculate() {
        if (selected_gender == "Male") {
            val bmr = 10 * weightAmount.toDouble() + 6.25 * heightAmount.toDouble() - 5 * ageAmount + 5
            bmrTextView!!.text = """${NumberFormat.getNumberInstance().format(bmr)}
 Calories/day"""
        } else if (selected_gender == "Female") {
            val bmr = 10 * weightAmount.toDouble() + 6.25 * heightAmount.toDouble() - 5 * ageAmount - 161
            bmrTextView!!.text = """${NumberFormat.getNumberInstance().format(bmr)}
 Calories/day"""
        }
    }
